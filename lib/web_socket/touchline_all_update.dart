...
TouchlineAllUpdateStream touchlineAllUpdateStreamFromJson(String str) =>
    TouchlineAllUpdateStream.fromJson(json.decode(str) as Map<String, dynamic>);

String touchlineAllUpdateStreamToJson(TouchlineAllUpdateStream data) =>
    json.encode(data.toJson());

class TouchlineAllUpdateStream {
  TouchlineAllUpdateStream({
    required this.ts,
    required this.t,
    required this.e,
    required this.tk,
  ...
  factory TouchlineAllUpdateStream.fromJson(Map<String, dynamic> json) {
    final String? task =
    ...
    final String? volume =
        ...
        json["v"].toString() == null || json["v"].toString() == "null"
            ? null
            : json["v"].toString();
    return TouchlineAllUpdateStream(
      ts: instrument_name,
      t: task,
      e: exchange,
      tk: token,
