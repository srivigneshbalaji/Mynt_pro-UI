// ignore_for_file: unnecessary_null_comparison, unnecessary_nullable_for_final_variable_declarations

import 'dart:convert';

DepthWSResponse depthWSResponseFromJson(String str) =>
    DepthWSResponse.fromJson(json.decode(str) as Map<String, dynamic>);

String depthWSResponseToJson(DepthWSResponse data) =>
  ...
  factory DepthWSResponse.fromJson(Map<String, dynamic> json) {
    ...
    final String? bq5Val =
        json["bq5"].toString() == null || json["bq5"].toString() == "null"
            ...
            : json["bq5"].toString();
    final String? lsVal =
        json["ls"].toString() == null || json["ls"].toString() == "null"
            ? "0"
            : json["ls"].toString();
    final String? ltqVal =
        json["ltq"].toString() == null || json["ltq"].toString() == "null"
            ...
            : json["ltq"].toString();
    final String? lttVal =
        json["ltt"].toString() == null || json["ltq"].toString() == "null"
            ? "0"
            : json["ltt"].toString();
    final String? sp1Val =
    ...
    final String? sp3Val =
        json["sp3"].toString() == null || json["sp3"].toString() == "null"
            ...
            : json["sp3"].toString();
    final String? sp4Val =
        json["sp4"].toString() == null || json["sp4"].toString() == "null"
            ? "0"
            : json["sp4"].toString();
    final String? sp5Val =
        json["sp5"].toString() == null || json["sp5"].toString() == "null"
            ? "0"
            : json["sp5"].toString();
    final String? oiVal =
        json["oi"].toString() == null || json["oi"].toString() == "null"
            ...
            : json["oi"].toString();
    final String? ppVal =
        json["pp"].toString() == null || json["pp"].toString() == "null"
            ? "0"
            : json["pp"].toString();
    ...
    final String? l52Val =
        json["52l"].toString() == null || json["52l"].toString() == "null"
            ...
            : json["52l"].toString();
    final String? tbqVal =
        json["tbq"].toString() == null || json["tbq"].toString() == "null"
            ? "0"
            : json["tbq"].toString();
    final String? tsqVal =
        json["tsq"].toString() == null || json["tsq"].toString() == "null"
            ? "0"
            : json["tsq"].toString();
    final String? lcVal =
